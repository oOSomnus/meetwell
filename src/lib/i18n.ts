...
const zhMessages = {
  ...
  minimumDurationHours: '最小时长小时数',
  minimumDurationMinutes: '最小时长分钟数',
  settings: '设置',
  timezoneSettings: '时区设置',
  timezoneSettingsIntro: '设置主用和备用时区，常用选择会显示在时区列表顶部。',
  primaryTimezone: '主用时区',
  secondaryTimezone: '备用时区',
  primaryTimezoneHelp: '保存后会立即作为当前结果时区。',
  secondaryTimezoneHelp: '可选；会以星标显示在列表顶部。',
  timezonePinned: '星标时区',
  timezoneRecent: '最近使用',
  timezoneAll: '全部时区',
  timezoneSearchPlaceholder: '搜索时区，例如 Tokyo 或 Shanghai',
  timezoneNoResults: '没有匹配的时区',
  clearSecondaryTimezone: '清除备用时区',
  timezoneSettingsSaved: '时区设置已保存',
  ...
  timeRules: '时间规则',
  add: '新增',
  rulesIntro: '计算范围内每天默认可用；覆盖时间会进一步取交集，排除时间会从结果中扣除。',
  ...
  timeInputHelp: '可直接输入 24 小时制时间，例如 09:30。',
...
const enMessages = {
  ...
  minimumDurationHours: 'Minimum duration hours',
  minimumDurationMinutes: 'Minimum duration minutes',
  settings: 'Settings',
  timezoneSettings: 'Timezone settings',
  timezoneSettingsIntro: 'Set primary and secondary time zones. Frequent choices stay at the top of the list.',
  primaryTimezone: 'Primary timezone',
  secondaryTimezone: 'Secondary timezone',
  primaryTimezoneHelp: 'Saving it also switches the current result timezone.',
  secondaryTimezoneHelp: 'Optional; shown with a star at the top of the list.',
  timezonePinned: 'Starred time zones',
  timezoneRecent: 'Recently used',
  timezoneAll: 'All time zones',
  timezoneSearchPlaceholder: 'Search time zones, e.g. Tokyo or Shanghai',
  timezoneNoResults: 'No matching time zones',
  clearSecondaryTimezone: 'Clear secondary timezone',
  timezoneSettingsSaved: 'Timezone settings saved',
  ...
  add: 'Add',
  rulesIntro: 'Each day in the calculation range is available by default; availability windows narrow the intersection, and excluded time is removed from the result.',
  ...
  endTime: 'End time',
  timeInputPlaceholder: 'HH:mm',
  timeInputHelp: 'Type a 24-hour time directly, such as 09:30.',
  ...
  noAvailableReason: 'No available time on this day',
